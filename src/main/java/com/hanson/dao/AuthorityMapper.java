...
public interface AuthorityMapper {
    ...
    * @params: [index, currentPage] index：开始索引，pageSize:页大小
    * @return: java.util.List<com.hanson.pojo.Authority> 权限信息，list集合
    * @Date: 2020/4/19
    */
    public List<Authority> doSplitAuthority(@Param("startIndex") Integer index,@Param("pageSize") Integer pageSize);
    ...
    * @Date: 2020/4/19
    */
    public Integer doDeleteAuthorityById(@Param("authorityId") Integer id);
    ...
    * @Date: 2020/5/12
    */
    public List<Authority> doSearchAuthoritySplit(@Param("startIndex") Integer startIndex,@Param("pageSize") Integer pageSize,@Param("searchKey") String key);
    ...
    * @Date: 2020/5/12
    */
    public List<Authority> doSearchAuthority(@Param("searchKey")String key);
