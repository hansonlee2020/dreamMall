...
<div class="section">
    <div class="right-back">
        <a class="btn btn-link" style="display: inline-block" href="${pageContext.request.contextPath}/toHome">返回首页</a>
    </div>
                ...
                <form class="form-horizontal" id="add-product-form">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="product-name" name="product-name" required spellcheck="false">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="price" name="price" required spellcheck="false">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="stock" name="stock" required spellcheck="false">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="limit-num" name="limit-num" required spellcheck="false">
                        ...
                        <div class="form-actions">
                            <button type="button" class="btn btn-primary md-trigger" id="put" data-modal="message-window" disabled>保存修改</button>
<%--                            <button type="button" class="btn btn-primary md-trigger" id="add" data-modal="message" disabled>保存修改</button>--%>
        ...
        <div class="context">
            <div class="message">
                ...
                <div class="confirm-btn">
                    <input type="button" id="confirm" class="put md-close" value="确认" onmouseover="changeBtn(this)" onmouseout="initBtn(this)">
                </div>
